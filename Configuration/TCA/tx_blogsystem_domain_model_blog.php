    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table' => 'tx_blogsystem_domain_model_blog',
                'foreign_table_where' => 'AND {#tx_blogsystem_domain_model_blog}.{#pid}=###CURRENT_PID### AND {#tx_blogsystem_domain_model_blog}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
        ...
        'title' => [
            'exclude' => true,
            'label' => 'LLL:EXT:blog_system/Resources/Private/Language/locallang_db.xlf:tx_blogsystem_domain_model_blog.title',
            'description' => 'LLL:EXT:blog_system/Resources/Private/Language/locallang_db.xlf:tx_blogsystem_domain_model_blog.title.description',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'default' => ''
        ...
        'image' => [
            'exclude' => true,
            'label' => 'LLL:EXT:blog_system/Resources/Private/Language/locallang_db.xlf:tx_blogsystem_domain_model_blog.image',
            'description' => 'LLL:EXT:blog_system/Resources/Private/Language/locallang_db.xlf:tx_blogsystem_domain_model_blog.image.description',
            'config' => [
                'type' => 'file',
